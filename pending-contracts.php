...
$myID = $_SESSION['id'];
$fetchPendingQuery = "SELECT * FROM contracts WHERE customer_id=$myID AND status='Pending Two'";
...
echo "<th style='width:100px;'>Checkout</th>";
echo "</tr>";
echo "</thead>";
$counter = 1;
$chestSize;
...
while ($contractsRow = mysqli_fetch_assoc($fetchResult)) {
    ...
    echo "<td><a href='./actions/checkout-and-approve.api.php?id=$orderID'>Approve</a></td>";
    echo "</tr>";
}
?>
</tbody>
